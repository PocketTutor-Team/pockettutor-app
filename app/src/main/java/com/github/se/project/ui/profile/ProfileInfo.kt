...
fun ProfileInfoScreen(
    ...
    val completedLessons = lessons.value.filter {
        ...
        profileState.value?.let { profile ->
            ...
            if (showVerificationDialog && isTutor) {
                EpflVerificationDialog(
                    ...
                    onVerify = { sciper ->
                        certificationViewModel.verifySciperNumber(sciper)
                    }
                )
            }
        }
        ...
        Column(
            ...
            Row(
                ...
                Box {
                    ...
                    if (profile.role == Role.TUTOR) {
                        Surface(
                            ...
                            shape = CircleShape,
                            color = if (profile.certification?.verified == true)
                                Color.White
                            else
                            ...
                            Icon(
                                ...
                                modifier = Modifier
                                    .padding(4.dp)
                                    .size(20.dp),
                                tint = if (profile.certification?.verified == true) Color.Red else MaterialTheme.colorScheme.onPrimary
                            )
                        }
                    }
                }
                ...
                Column(
                    ...
                    Text(
                        text = "${profile.firstName.capitalizeFirstLetter()} ${profile.lastName.capitalizeFirstLetter()}",
            ...
            Row(
                ...
                StatItem(
                    ...
                    label = if (profile.role == Role.TUTOR) "Lessons Given" else "Lessons Taken",
                    icon = Icons.Default.CheckCircle
                )
                if (profile.role == Role.TUTOR) {
                    StatItem(
