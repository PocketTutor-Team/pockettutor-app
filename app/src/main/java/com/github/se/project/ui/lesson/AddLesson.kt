...
fun AddLessonScreen(
    ...
    /**
     * Lambda function to handle lesson confirmation. Either schedules a new lesson or updates
     * the selected lesson, depending on the user's input.
     *
    ...
    val onConfirm = { lesson: Lesson ->
        ...
        if (isInstant(lesson)) {
            ...
            if (lessons.any {
                    it.status == LessonStatus.INSTANT_REQUESTED ||
