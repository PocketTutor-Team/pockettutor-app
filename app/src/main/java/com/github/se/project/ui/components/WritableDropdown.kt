 ...
 * through a list of choices. Once a choice is selected, it updates the value and closes the dropdown.
 *
 ...
 * @param onValueChange A callback function that is triggered when the value of the text field changes.
 * @param choices A list of strings representing the available choices to be displayed in the dropdown.
 */
@Composable
fun WritableDropdown(
    ...
    Box {
        /**
         * Outlined text field for user input. The dropdown expands when the user types,
         * and contracts when the input is empty.
         */
        OutlinedTextField(
            ...
            modifier = Modifier.testTag("dropdown").fillMaxWidth(), // Full-width and test tag for testing.
            singleLine = true) // Ensures the text field is a single line.

        /**
         * Dropdown menu that appears below the text field when the user starts typing.
         * It shows only the filtered choices based on the user's input.
         */
        DropdownMenu(
            ...
            modifier = Modifier.fillMaxWidth().zIndex(1f), // Full-width and ensures dropdown appears above other elements.
            ...
            choices
                .filter { v -> (v.startsWith(value) || v.lowercase().startsWith(value)) } // Filters choices.
                .forEach { v ->
                    /**
                     * A dropdown menu item for each matching choice. When clicked, it updates
                     * the value of the text field and collapses the dropdown.
                     */
                    DropdownMenuItem(
