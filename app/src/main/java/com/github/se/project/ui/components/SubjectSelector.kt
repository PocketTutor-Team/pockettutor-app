 ...
 *
 * @param selectedSubject A [MutableState] object representing the currently selected subject (used
 *   for single-selection mode). Pass `null` for multiple-selection mode.
...
fun SubjectSelector(
  ...
  Box(modifier = Modifier.fillMaxWidth()) {
    /**
     * Button to toggle the dropdown menu. Displays the currently selected subject(s) or a
     * placeholder text if none are selected.
     */
    Button(
    ...
    /**
     * Dropdown menu displaying the list of subjects. Supports single or multiple selection modes.
     */
    DropdownMenu(
