...
/**
 * Composable function for the "Edit Requested Lesson" screen. Allows users to edit or delete
 * an existing lesson that is in the "requested" state.
 *
...
fun EditRequestedLessonScreen(
    ...
    /**
     * Lambda function to handle lesson updates. Updates the lesson details and navigates
     * back to the home screen upon completion.
     *
    ...
    /**
     * Lambda function to handle lesson deletion. Deletes the selected lesson and navigates
     * back to the home screen upon completion.
     *
    ...
    /**
     * Displays the LessonEditor component, which allows users to edit lesson details or delete
     * the lesson.
     *
