...
class AddLessonTest {
    ...
    val mockProfiles = Mockito.mock(ListProfilesViewModel::class.java).apply {
    ...
    fun sliderTest() {
        ...
        var changed = false
        composeTestRule.setContent {
            PriceSlider("testLabel") { a, b -> changed = true }
        }

        // Perform the sliding action on the slider
        composeTestRule.onNodeWithTag("priceSlider").performTouchInput{
            swipeRight()
        }
    ...
    fun validateValidatesValidly() {
        ...
        assert(validateLessonInput("title", "description", "AICC", "language", "date", "") == "time is missing")
        assert(validateLessonInput("title", "description", "subject", "language", "", "time") == "date is missing")
        assert(validateLessonInput("title", "description", "subject", "language", "date", "time") == "Invalid subject")
    }
