...
class AvailabilityScreenTest {
    ...
    fun availabilityScreen_displaysProfileNameAndInstructions() {
        ...
        composeTestRule.onNodeWithTag("InstructionsText")
            .assertTextEquals("Finish your account creation by selecting the time slots you're available during the week:")
    ...
    fun availabilityGrid_togglesSelection() {
        ...
        composeTestRule.runOnIdle {
            ...
            profile?.schedule?.let { schedule ->
                ...
                // mockProfileFlow.value = profile.copy(schedule = updatedSchedule) // Uncomment if you need to update flow
